...
class SICREDIForms(CustomForms):
    ...
    path_SICREDI = forms.ChoiceField(
        label="Diretório para salvar",
        choices=DIRECTORY_CHOICES,
        required=True,
        widget=forms.Select(
...
class RecibosPagForms(CustomForms):
    ...
    path_recibos_pag = forms.ChoiceField(
        label="Diretório para salvar",
        choices=DIRECTORY_CHOICES,
        required=True,
        widget=forms.Select(
...
class ImpostoRendaForms(CustomForms):
    ...
    path_imposto_renda = forms.ChoiceField(
        label="Diretório para salvar",
        choices=DIRECTORY_CHOICES,
        required=True,
        widget=forms.Select(
...
class SomaPayForms(CustomForms):
    ...
    path_somapay = forms.ChoiceField(
        label="Diretório para salvar",
        choices=DIRECTORY_CHOICES,
        required=True,
        widget=forms.Select(
...
class ScannerForms(CustomForms):
    arquivo_scanner = forms.FileField(
        label="Arquivo",
        required=True,
        widget=forms.FileInput(
            attrs={
    ...
    # Campo para selecionar o diretório
    path_scanner = forms.ChoiceField(
        label="Diretório para salvar",
        choices=DIRECTORY_CHOICES,
        required=True,
        widget=forms.Select(
